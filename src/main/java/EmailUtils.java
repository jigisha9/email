...
public class EmailUtils {
    ...
    public EmailUtils(String username, String password, String server, EmailFolder emailFolder) throws MessagingException {
        ...
        try {
            ...
            props.load(new FileInputStream(new File("C:/Jigisha/Automation/src/main/resources/email.properties")));
        } catch(Exception e) {
            e.printStackTrace();
            System.exit(-1);
        }
        ...
        System.out.println("=============folder==========" + emailFolder.getText());
    ...
    //    System.out.print("message count" + message.getContent());
        message.getContent();
    }

    public int getNumberOfMessages() throws MessagingException {
        System.out.println("total message count: " + folder.getMessageCount());
    ...
    public Message getMessageByIndex(int index) throws MessagingException {
        System.out.println("latest message: "+ folder.getMessage(1));
        return folder.getMessage(index);
    }

    public Message getLatestMessage() throws MessagingException{
        System.out.println("message count" + getMessageByIndex(getNumberOfMessages()));
        ...
        if(unreadOnly){
            ...
            for (Message message : messages) {
                if(isMessageUnread(message)) {
                    System.out.println("Unread message subject" + message.getSubject());
    ...
    public String getMessageContent(Message message) throws Exception {
        ...
        System.out.println("email contenct" + builder.toString());
    ...
    public String getAuthorizationCode() throws Exception {
        ...
        while ((line = reader.readLine()) != null) {
            if(line.startsWith(prefix)) {
                System.out.println("======match prefix====="+line);
